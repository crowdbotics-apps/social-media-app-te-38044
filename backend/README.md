...
## Project Structure
    ...
    ├── social_media_app_te_38044  # Django project configurations
...
1. Clone this repo and `cd social_media_app_te_38044`
...
2. Clone this repo and `cd social_media_app_te_38044`
